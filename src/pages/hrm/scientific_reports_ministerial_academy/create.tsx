        ...
        <div className="p-5">
            <ul className="flex space-x-2 rtl:space-x-reverse mb-6">
                ...
                <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                    <Link href="/hrm/scientific_reports_ministerial_academy" className="text-primary hover:underline">
            ...
            <div className='flex justify-between header-page-bottom pb-4 mb-4'>
                <h1 className='page-title'>BCNVKH cấp Học viện</h1>
                <Link href="/hrm/scientific_reports_ministerial_academy">
