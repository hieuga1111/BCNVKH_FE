...
const Duty = ({ ...props }: Props) => {
    ...
    useEffect(() => {
        dispatch(setPageTitle(`BCNVKH cấp Bộ`));
    });
    ...
    // get data
    const { data: shift, pagination, mutate } = Shifts({ management_level_id: 'B', ...router.query, size: pageSize });
    ...
    const handleEdit = (data: any) => {
        router.push(`/hrm/scientific_reports_ministerial/${data.id}`)
    };
    ...
    const handleDetail = (data: any) => {
        router.push(`/hrm/scientific_reports_ministerial/detail/${data.id}`)
    };
    const columns = [
        {
            accessor: 'id',
    ...
    const handleBackup = () => {
        ...
        swalDeletes
            ...
            .then((result) => {
                if (result.value) {
                    reportScientificReports('B').then((res) => {
                        console.log(res)
            ...
            <div className="panel mt-6">
                <div className="flex md:items-center justify-between md:flex-row flex-col mb-4.5 gap-5">
                    <div className="flex items-center flex-wrap">
                        {
                            role_id === 'U' ? <></> : <>
                                <Link href="/hrm/scientific_reports_ministerial/create">
