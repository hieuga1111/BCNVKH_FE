...
const Duty = ({ ...props }: Props) => {
    ...
    useEffect(() => {
        dispatch(setPageTitle(`BCNVKH cấp Cơ sở`));
    });
    ...
    const handleEdit = (data: any) => {
        router.push(`/hrm/scientific_reports_ministerial_grassroots/${data.id}`)
    };
    ...
    const handleBackup = () => {
        ...
        swalDeletes
            ...
            .then((result) => {
                if (result.value) {
                    reportScientificReports('CS').then((res) => {
                        console.log(res)
