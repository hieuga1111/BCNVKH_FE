...
const File = ({ ...props }: Props) => {
    ...
    useEffect(() => {
        dispatch(setPageTitle(`Lịch sử chỉnh sửa báo cáo`));
    });
    ...
    // get data
    const { data: shift, pagination, mutate } = History({ path: '/api/scientific_reports/', method: 'put', ...router.query, size: pageSize });
        ...
        <div>
            <ul className="flex space-x-2 rtl:space-x-reverse mb-6">
                ...
                <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                    <span>Lịch sử chỉnh sửa báo cáo</span>
