...
// helper
import { capitalize, formatdata, formatDate, showMessage } from '@/@core/utils';
// icons
...
import { Stat } from '@/services/swr/stat.swr';
...
const Duty = ({ ...props }: Props) => {
    ...
    // get data
    const { data: shift, pagination, mutate } = Stat({ ...router.query, size: pageSize });
    ...
    const columns = [
        ...
        },
        {
            ...
            title: `Đơn vị`,
            sortable: false,
            render: (records: any, index: any) => <span>{records?.unit}</span>
        },
        {
            accessor: 'chutri',
            title: `Số lượng đề tài chủ trì`,
            sortable: false,
            render: (records: any, index: any) => <span>{records?.chutri}</span>
        },
        {
            accessor: 'thuchien',
            title: `Số lượng đề tài thực hiện`,
            sortable: false,
            render: (records: any, index: any) => <span>{records?.thuchien}</span>
        },
        {
            accessor: 'phoiHop',
            title: `Số lượng đề tài phối hợp`,
            sortable: false,
            render: (records: any, index: any) => <span>{records?.phoiHop}</span>
        },
        {
            accessor: 'tong',
            title: `Tổng`,
            sortable: false,
            render: (records: any, index: any) => <span>{records?.tong}</span>
        },
    ]
    const handlePrint = () => {
        window.print();
